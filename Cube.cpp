...
Cube::Cube(View &canvas, Viewer &camera, PointMatrix *f):Object{ canvas, camera }
{
...
Cube::Cube(const Object &copyCybe) :Object{ copyCybe }
{
}

Cube::Cube(Object &&moveCobe) :Object{ move(moveCobe) }
{
}
